...
#################################################
orf <- raster("../OUTPUT/20231204/Obs_NCUMG_day1_20231204_Thr40_Object3.nc")
mrf <- raster("../OUTPUT/20231204/Model_NCUMG_day1_20231204_Thr40_Object3.nc")
orf[orf<40]=NA;
mrf[mrf<40]=NA;
rotated<-raster("../OUTPUT/20231204/20231204_Thr40_NCUMG_day1RotatedModel_3.nc")
crat=40 ######### Enter Rainfall threshold here (RF in mm/day units)
orft<-orf
mrft<-mrf
png(file="CRAplot_20231204_Th40_NCUMG_day1_3.png",width = 650, height = 650, units = "px", pointsize = 12, bg = "white",  res = NA)
...
pdata=read.delim("../OUTPUT/20231204/20231204_Thr40_NCUMG_day1_3_ScatterData.txt", header = TRUE, sep = "")
pdata[pdata<40]=NA;
...
testdf1<-read.table("../OUTPUT/20231204/20231204_Thr40_NCUMG_day1_3_Table1.txt")
# Push viewport
pushViewport(viewport(x=0.610,y=0.40,height=0.8,width=0.5))
grid.table(testdf1,theme=tt)
#
testdf2<-read.table("../OUTPUT/20231204/20231204_Thr40_NCUMG_day1_3_Table2.txt")
# Push viewport
...
#
testdf3<-read.table("../OUTPUT/20231204/20231204_Thr40_NCUMG_day1_3_Table3.txt",header = FALSE,sep = ",")
...
#
testdf4<-read.table("../OUTPUT/20231204/20231204_Thr40_NCUMG_day1_3_Table4.txt")
