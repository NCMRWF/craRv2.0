...
figname=CRAplot_${date}_Th${Threshold}_${case}_${ObjNum}_NoRot.png
###################################################
...
par(mfrow=c(2,2), family="serif", mai=c(0.6,0.6,0.6,0.6),cex.axis = 1.5,cex.main = 2,font = 2,cex.axis = 1.5)
## Obs plot
...
title(ylab="Model (Shifted)",mgp=c(3,1,0),cex.lab=2,font=2)
...
# Push viewport
pushViewport(viewport(x=0.590,y=0.490,height=0.8,width=1.0))
